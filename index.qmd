...
ggplot(quadrants, aes(x = x, y = y)) +
  ...
  labs(title = "Internal Validity × External Validity",
       ...
       x = "Internal Validity (Causal Inference)") +
  theme_void() +
  theme(
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  <ul>
    ...
    <li><strong>Question:</strong> "Do the group means differ?"</li></ul>
    <p><strong>Post-hoc tests</strong> If ANOVA shows significance, follow up with a post-hoc test like a Tukey's HSD to determine which groups differ.</p>`,
